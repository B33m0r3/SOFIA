...
def main(argv=None) -> int:
    ...
    p.add_argument("--multi-ap", action="store_true",
                   help="Linux: read every strong AP as a separate illuminator "
                        "(floor-plan heatmap; pair with --interval 2)")
